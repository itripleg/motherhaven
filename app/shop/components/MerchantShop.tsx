// app/shop/components/MerchantShop.tsx
'use client';
...
import { type ShopItem, SHOP_ITEMS, RARITY_COLORS } from '../types';
...
export default function MerchantShop({ userBalance = 15000, onPurchase }: MerchantShopProps) {
    ...
    <div className="min-h-screen animated-bg floating-particles">
      ...
      <div className="relative z-10 container mx-auto p-6 pt-24 space-y-8">
        ...
        >
          ...
          {/* Balance */}
          <Card className="w-fit mx-auto unified-card border-primary/30">
        ...
        {/* Merchant Speech - simplified */}
        <motion.div className="text-center">
          <Card className="w-fit mx-auto unified-card border-accent/40 bg-accent/10">
            <CardContent className="p-3">
              <motion.p
                key={merchantSays}
                initial={{ opacity: 0 }}
        ...
        <AnimatePresence>
          {hoveredItem && (
            ...
            >
              <Card className="unified-card border-primary/30 bg-background/95 backdrop-blur">
