// app/factory/components/editor/FactoryEditorPreview.tsx
"use client";
...
interface FactoryEditorPreviewProps {
  tokenName: string;
  tokenSymbol: string;
  description?: string;
  imageFile?: File | null;
...
export const FactoryEditorPreview: React.FC<FactoryEditorPreviewProps> = ({
