// app/dex/components/token-header/TokenHeaderBackground.tsx
"use client";
import React from "react";
import { ImagePosition } from "./types";

interface TokenHeaderBackgroundProps {
  imageUrl?: string;
...
export const TokenHeaderBackground: React.FC<TokenHeaderBackgroundProps> = ({
  imageUrl,
