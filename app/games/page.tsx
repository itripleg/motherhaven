...
const GamesPortal: React.FC = () => {
  ...
  const bigBrainGame: Game = {
    ...
    description:
      "Challenge the AI in strategic battles of wit and intelligence. Burn BBT tokens to enter battles with varying difficulty levels and win AVAX rewards based on your performance.",
    shortDescription: "Strategic AI battles with AVAX rewards",
    category: "strategy",
    // status: "live",
    status: "development",
    difficulty: "easy",
