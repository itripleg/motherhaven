    ...
    <>
      ...
      <div className="hidden md:block fixed top-4 left-1/2 transform -translate-x-1/2 z-50">
        ...
        >
          ...
          <MenubarMenu>
            ...
            <MenubarContent className="rounded-xl border-border/50 bg-background/95 backdrop-blur-md shadow-xl">
              {/* Factory Address */}
              <MenubarItem>
                <Link
                  href="/dex/factory"
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-border/50">
        <Menubar
          className={cn(
            "bg-background/90 backdrop-blur-md border border-border/50 shadow-lg",
            "rounded-2xl px-2 py-1 min-h-12 mx-auto w-fit",
            "transition-all duration-300 hover:shadow-xl hover:bg-background/95"
          )}
        >
          {/* Brand */}
      ...
      <div className="md:hidden px-4">
        ...
        >
          ...
          {/* Factory Address - Compact version */}
